# ifndef MINPACK2_TPROBS_92_HPP_DGL1FG_HPP
# define MINPACK2_TPROBS_92_HPP_DGL1FG_HPP
...
int dgl1fg(integer *n, doublereal *x, doublereal *f,
...
//  Compute the standard starting point if task = 'XS'.
	...
	temp = sqrt((betas + betan) / ((fabs(alphas) + fabs(alphan)) * 2.));
	i__1 = *n;
