/* minpack2/tprobs.92/dierfj.f -- translated by f2c (version 20190311).
...
/* Subroutine */ int dierfj_(integer *n, doublereal *x, doublereal *fvec, 
	...
	doublereal *b, doublereal *c__, integer *nint, ftnlen task_len)
{
    ...
    static doublereal icond[3] = { 0.,0.,0. };
