# ifndef SRC_FUN_OBJ_FUN_DIERFJ_HPP
# define SRC_FUN_OBJ_FUN_DIERFJ_HPP

# include "fun_base.hpp"

// declare dierfj function interface
class fun_dierfj : public fun_base {
...
private:
    ...
    // x coordinate of right end of rod
    const double a_;
    // y coordinate of right end of rod
    const double b_;
    // angle at right end of rod
    const double c_;
    // arugment vector
    d_vector x_;
